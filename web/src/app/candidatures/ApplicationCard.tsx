    ...
    <article className="rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <span className="text-sm text-slate-500">Date: {formatDate(application.applied_at)}</span>
        </div>
        ...
        <div className="flex flex-col gap-2 border-t border-slate-100 pt-4">
          <div className="grid grid-cols-2 gap-2">
            {document?.hasPdf ? (
              ...
              <span className="flex h-11 items-center justify-center rounded-lg border border-slate-200 bg-slate-50 px-3 text-sm font-medium text-slate-400">
                PDF absent
              </span>
            )}
            {document?.hasDocx ? (
